...
if (isset($_POST['login'])) {
	...
	if ($username != "" && $password != "") {
		...
		$user_id = $user_service->getIdByUsernameAndPassword($username, $password);
	...
	<section class="d-flex align-items-center w-100 h-100 position-absolute">
		<section class="card bg-dark text-white text-center px-5 col-xs-12 col-sm-8 col-md-7 col-lg-5 col-xl-3 mx-auto">
			<form method="POST">
				...
				<p class="mt-4"><a class="text-decoration-none text-danger" href="forgotpassword">Forgot password?</a>
				</p>
				<p class="mt-4"><small>New to Game Store? <a class="text-decoration-none text-danger"
							href="home#registration">Create an account</a></small></p>
				<?php if ($error): ?>
